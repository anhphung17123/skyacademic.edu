  ...
  const blocks = [
    {
      id: 'courses',
      icon: GraduationCap,
      titleKey: 'home.featuredBlocks.courses.title',
      descriptionKey: 'home.featuredBlocks.courses.description',
      buttonKey: 'home.featuredBlocks.courses.button',
      link: '/courses',
    ...
    },
    {
      id: 'books',
      icon: BookOpen,
      titleKey: 'home.featuredBlocks.books.title',
      descriptionKey: 'home.featuredBlocks.books.description',
      buttonKey: 'home.featuredBlocks.books.button',
      link: '/products',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
          ...
          <div className="flex flex-col gap-6 min-h-0 md:h-full">
            {blocks.map((block) => {
              ...
              const description = t(block.descriptionKey);
              const buttonText = t(block.buttonKey);
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 flex flex-col h-full min-h-0">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 flex-1 min-h-[3.5rem] line-clamp-3 whitespace-pre-line mb-4">
                      {description}
                    </p>
            ...
            <div className="relative z-10 flex flex-col h-full min-h-0">
              <div className="flex items-center gap-3 mb-4 shrink-0">
                ...
                <h3 className="text-xl font-bold text-gray-900 dark:text-white group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors min-w-0 line-clamp-2">
                  {t('home.featuredBlocks.resources.title')}
                </h3>
              </div>
              <p className="text-gray-600 dark:text-gray-400 flex-1 leading-loose">
                {t('home.featuredBlocks.resources.description')}
              </p>
              <div className="space-y-2 shrink-0 mt-auto pt-4 border-t border-gray-200 dark:border-gray-600">
                ...
                <p className="font-semibold text-gray-500 dark:text-gray-400">{t('home.featuredBlocks.resources.joinGroup')}</p>
                <div className="flex flex-wrap gap-2">
                  {SKY_SHARE_CONFIG.whatsappGroupUrl && (
                    <a
                      ...
                      rel="noopener noreferrer"
                      onClick={(e) => e.stopPropagation()}
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 font-medium hover:bg-green-200 dark:hover:bg-green-900/50"
                    >
                  ...
                  {SKY_SHARE_CONFIG.zaloGroupUrl && (
                    <a
                      ...
                      rel="noopener noreferrer"
                      onClick={(e) => e.stopPropagation()}
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 font-medium hover:bg-blue-200 dark:hover:bg-blue-900/50"
                    >
