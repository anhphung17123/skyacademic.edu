...
export const FreeVideosSection = ({ videos: videosProp }: FreeVideosSectionProps = {}) => {
  const { t, i18n } = useTranslation();
  const { data: videos, isLoading } = useFeaturedData(freeVideoApi.fetchVideos, {
    initialData: videosProp,
    count: FEATURED_VIDEOS_COUNT,
  });
