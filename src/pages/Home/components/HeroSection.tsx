...
export const HeroSectionContent = ({ featuredVideo }: HeroSectionProps = {}) => {
  ...
  const { learnersCount, rating: heroRating } = mockSiteStats.hero;
  const highlights = [
    ...(learnersCount > 0 ? [t('hero.highlight1', { count: learnersCount })] : []),
    t('hero.highlight2'),
    t('hero.highlight3'),
  ];
  ...
  return (
    <>
      ...
      <section
        className={`relative min-h-[70vh] flex items-center lg:hidden overflow-hidden ${isLightMode
        ...
        <div className="container-custom relative z-10 py-10">
          <div className={clsx(
            ...
            <div className={clsx(
              ...
              {learnersCount > 0 && (
              <div
                className={`inline-flex items-center gap-2.5 rounded-full px-5 py-2.5 text-sm font-medium mb-4 ${isLightMode
              ...
              >
                ...
                {t('hero.badge', { count: learnersCount })}
              </div>
              )}
              ...
              <div className="space-y-3">
                ...
                <h2
                  className={`text-2xl sm:text-3xl lg:text-4xl font-display font-bold leading-tight bg-clip-text text-transparent ${isLightMode
              ...
              <div className={clsx(
                ...
                {highlights.map((item, index) => (
                  <div
                    key={index}
                    className={`flex items-center gap-2 px-4 py-2 rounded-lg ${isLightMode
              ...
              <div className={clsx(
                ...
                <a
                  ...
                  className={`group inline-flex items-center justify-center gap-2.5 border-2 font-semibold px-6 py-3 rounded-xl transition-all duration-300 ${isLightMode
                ...
                >
                  <div
                    className={`w-9 h-9 rounded-full flex items-center justify-center ${isLightMode ? 'bg-primary-100 group-hover:bg-primary-200' : 'bg-white/10 group-hover:bg-white/20'
                      } transition-colors`}
                  >
                ...
                {learnersCount > 0 && (
                  <div className="text-center lg:text-left">
                    <p className={`text-xl font-bold ${isLightMode ? 'text-gray-800' : 'text-gray-100'}`}>
                      {t('hero.highlight1', { count: learnersCount })}
                    </p>
