  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        medium:
          "0 4px 25px -3px rgba(0, 0, 0, 0.1), 0 10px 30px -2px rgba(0, 0, 0, 0.05)",
        "light-soft":
          "0 1px 3px 0 rgba(0, 0, 0, 0.05), 0 4px 12px -2px rgba(59, 130, 246, 0.08), 0 8px 24px -4px rgba(0, 0, 0, 0.04)",
        "light-medium":
          "0 4px 6px -1px rgba(0, 0, 0, 0.08), 0 10px 20px -4px rgba(59, 130, 246, 0.12), 0 20px 40px -8px rgba(0, 0, 0, 0.06)",
        "light-colored":
          "0 4px 12px -2px rgba(59, 130, 246, 0.15), 0 8px 24px -4px rgba(168, 85, 247, 0.1)",
      },
      animation: {
